...
public class SMParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("SM");
  ...
  { 
    SMParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = SMParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = SMParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(SMParseControllerGenerated.class);
    }
  ...
  { 
    return SMParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
